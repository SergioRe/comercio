...
$(document).ready(function() {
    var url = base_url + '/' + pathArray[1] + '/index.php/entrevistas/json/list';
    table = $('#tableentrevistas').DataTable({
        "pageLength": 7,
        "scrollX": true,
        "processing": true,
        "serverSide": true,
...
function destacado_salud(IdCategoria,IdVideo,DestacadoCategoria){
    var ruta = base_url + '/' + pathArray[1] + '/index.php/entrevistas/json/destacado';
    $.ajax({
        url: ruta,
        type: 'POST',
