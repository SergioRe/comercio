...
$(document).ready(function() {
    var url = base_url + '/' + pathArray[1] + '/index.php/vademecum/json/list';
    table = $('#tablevademecum').DataTable({
        "pageLength": 7,
        "scrollX": true,
        "processing": true,
        "serverSide": true,
...
function destacado_salud(IdCategoria,IdVideo,DestacadoCategoria){
    var ruta = base_url + '/' + pathArray[1] + '/index.php/vademecum/json/destacado';
    $.ajax({
        url: ruta,
        type: 'POST',
