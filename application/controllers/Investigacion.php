...
class Investigacion extends CI_Controller {
    ...
    public function index(){
        ...
        if(count($_POST) ==  0){
            $this->load->view('investigacion/index_view',$data);
        }else{
    ...
    public function listar(){
        ...
        if($this->session->userdata('logged_in')){
            ...
            $data['ApellidosUsu'] = $session_data['ApellidosUsu'];
            $data['tipousu'] = $session_data['TipoUsu'];
            $this->load->view('investigacion/listar_view',$data);
        }else{
        ...
        switch ($case):
            ...
            case 'list':
                ...
                foreach ($list as $categoria) {
                    ...
                    if($categoria->flag === 'I'){
                        $row[] = '<img style="width:100%;height:100px;" src="'.$urlContorlador.$categoria->ImagenVideo.'">';
                    }else{
