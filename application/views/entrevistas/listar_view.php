...
<html>
    ...
    <script src="<?php echo base_url('assets/bootstrap/js/entrevistas.js')?>" type="text/javascript"></script>
    ...
    <body style="background-color: #BDBDBD;">
        ...
        <div class="container" style="background-color: #FFFFFF;">
            ...
            <div class="row" style="background-color: #FFFFFF;text-align: left;">
                <div class="col-lg-6">
                    <h4><b style="color: #31708f;">Mantenimiento Entrevistas</b></h4>
                </div>
            ...
            <div class="col-lg-12">
                <table id="tableentrevistas" class="table table-striped table-bordered" cellspacing="0" width="100%">
                    <thead>
                        <tr>
