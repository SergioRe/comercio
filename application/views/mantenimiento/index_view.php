            ...
            <fieldset>
                <legend class="alert">
                    <div class="col-lg-6 text-left">
                        <b style="color: #31708f; text-align: left;">Mantenimiento Banner Publicitario</b>
                    </div>
                    <div class="col-lg-6">
                        <button type="button" class="btn btn-success btn-sm" id="btn-create" onclick="createrow();">
                            <span class="glyphicon glyphicon-plus-sign"></span> <b>Nuevo</b> 
                        </button>
                        <button type="button" class="btn btn-danger btn-sm" id="btn-delete" onclick="deleterow();">
                            <span class="glyphicon glyphicon-minus-sign"></span> <b>Eliminar</b>
                        </button>
