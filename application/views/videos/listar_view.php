...
<html>
    ...
    <script src="<?php echo base_url('assets/bootstrap/js/videos.js')?>" type="text/javascript"></script>
    ...
    <body style="background-color: #BDBDBD;">
        ...
        <div class="container" style="background-color: #FFFFFF;">
            ...
            <div class="col-lg-12">
                <table id="tablevideos" class="table table-striped table-bordered" cellspacing="0" width="100%">
                    <thead>
                        <tr>
