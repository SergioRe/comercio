...
<html>
    ...
    <script src="<?php echo base_url('assets/bootstrap/js/banner.js')?>" type="text/javascript"></script>
    ...
    <body style="background-color: #BDBDBD;">
        ...
        <div class="container" style="background-color: #FFFFFF;">
            ...
            <div class="row" style="background-color: #FFFFFF;text-align: left;">
                <div class="col-lg-6">
                    <h4><b style="color: #31708f;">Mantenimiento Banner Publicitario</b></h4>
                </div>
                <div class="col-lg-6" style="text-align: right;">
                    <button type="button" class="btn btn-success btn-sm" id="btn-create" onclick="agregar_banner_modal();">
